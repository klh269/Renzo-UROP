...
def GP_fit(args, r, Y, rad, make_plots:bool=False, file_name:str="", summary:bool=False):
...
def GP_residuals(r, Y, rad, pred_means, pred_bands, make_plots:bool=False, file_name:str=""):
    ...
    residuals = np.array([ res_Vbar, res_Vobs ])
